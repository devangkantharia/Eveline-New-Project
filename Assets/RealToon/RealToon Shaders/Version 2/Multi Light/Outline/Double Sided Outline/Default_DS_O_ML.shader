...
Shader "RealToon/Version 2/Multi Light/Outline/Double Sided/Default" {
    Properties {
        [Header((RealToon V2.0.1))]
    	[Header((Multi Light x Outline x Double Sided))]
    	[Header((Default))]
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = v.texcoord0;
                float4 node_4518 = _Time + _TimeEditor;
                float node_5371_ang = node_4518.g;
...
////// Emissive:
                ...
                float node_7773 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_659, node_9545, _FresnelOnLight )*lerp( node_659, node_6054, _FresnelOnSelfShadow ))));
                float3 node_137 = ((node_7773*_FresnelColor.rgb)*_FresnelIntensity); // Fresnel
                float3 node_6957 = ( lerp(0.5,1.0,_TextureWashout) > 0.5 ? (1.0-(1.0-2.0*(lerp(0.5,1.0,_TextureWashout)-0.5))*(1.0-_Texture_var.rgb)) : (2.0*lerp(0.5,1.0,_TextureWashout)*_Texture_var.rgb) );
                float3 node_4607 = (node_6957*_Color.rgb);
                float3 node_1335 = ((float3(float2(i.screenPos.r,7.5),0.0)+normalDirection+float3(float2((-2.4),i.screenPos.g),0.0))*0.2);
                float4 _FReflection_var = tex2D(_FReflection,TRANSFORM_TEX(node_1335, _FReflection));
                ...
                float3 node_7979 = lerp(float3(node_7012,node_7012,node_7012),lerp(lerp(float3(node_132,node_132,node_132),(node_6957*0.9),_MainTextureColorAO),float3(node_8829,node_8829,node_8829),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
                float3 node_4224 = (node_3766*UNITY_LIGHTMODEL_AMBIENT.rgb*lerp( 1.0, node_7979, _ShowAOonAmbientLight ));
                ...
                float2 node_1592 = (1.0 - (reflect(viewDirection,normalDirection).rg*0.5+0.5));
                float4 _GlossTexture_var = tex2D(_GlossTexture,TRANSFORM_TEX(node_1592, _GlossTexture));
                float3 node_5108 = lerp(_GlossTexture_var.rgb,dot(_GlossTexture_var.rgb,float3(0.3,0.59,0.11)),0.0);
                float node_3167 = 0.0;
                float node_5033 = lerp((lerp( smoothstep( 0.79, 0.9, (node_9744*3.0) ), node_9744, _SoftGloss )*1.0),lerp( node_5108, lerp(float3(node_3167,node_3167,node_3167),node_5108,node_9545), _SelfShadowMaskGlossTexture ),_GlossTextureIntensity);
                float node_7216 = 0.0;
                ...
                float node_4649 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_9648,node_9648,node_9648),saturate((1.0-((1.0-0.44)/node_6957))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_7979,float3(node_881,node_881,node_881),node_9545), node_7979, _ShowAOonLight ))+(lerp(float3(node_3998,node_3998,node_3998),lerp( lerp(float3(node_5033,node_5033,node_5033),(node_5033*_GlossColor.rgb),2.22), lerp(float3(node_7216,node_7216,node_7216),node_6957,node_5033), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_4649,node_4649,node_4649),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),dot(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_9648,node_9648,node_9648),saturate((1.0-((1.0-0.44)/node_6957))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_7979,float3(node_881,node_881,node_881),node_9545), node_7979, _ShowAOonLight ))+(lerp(float3(node_3998,node_3998,node_3998),lerp( lerp(float3(node_5033,node_5033,node_5033),(node_5033*_GlossColor.rgb),2.22), lerp(float3(node_7216,node_7216,node_7216),node_6957,node_5033), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_4649,node_4649,node_4649),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
...
////// Lighting:
                ...
                float node_5038 = (1.0 - _ReduceWhite);
                float node_3161 = (1.0 - _Saturation);
                float3 finalColor = lerp(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_9648,node_9648,node_9648),saturate((1.0-((1.0-0.44)/node_6957))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_7979,float3(node_881,node_881,node_881),node_9545), node_7979, _ShowAOonLight ))+(lerp(float3(node_3998,node_3998,node_3998),lerp( lerp(float3(node_5033,node_5033,node_5033),(node_5033*_GlossColor.rgb),2.22), lerp(float3(node_7216,node_7216,node_7216),node_6957,node_5033), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_4649,node_4649,node_4649),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),dot(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_9648,node_9648,node_9648),saturate((1.0-((1.0-0.44)/node_6957))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_7979,float3(node_881,node_881,node_881),node_9545), node_7979, _ShowAOonLight ))+(lerp(float3(node_3998,node_3998,node_3998),lerp( lerp(float3(node_5033,node_5033,node_5033),(node_5033*_GlossColor.rgb),2.22), lerp(float3(node_7216,node_7216,node_7216),node_6957,node_5033), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_4649,node_4649,node_4649),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
