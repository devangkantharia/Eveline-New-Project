...
//RealToon V2.0.01 Shader
//Made By MJQStudioWorks
//Made Using Shader Forge
//2017

Shader "RealToon/Version 2/Multi Light/No Outline/Fade Transparency" {
    Properties {
...
////// Emissive:
                ...
                float node_8684 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_3073, node_9545, _FresnelOnLight )*lerp( node_3073, node_6054, _FresnelOnSelfShadow ))));
                float3 node_137 = ((node_8684*_FresnelColor.rgb)*_FresnelIntensity); 
                float3 node_5404 = ( lerp(0.5,1.0,_TextureWashout) > 0.5 ? (1.0-(1.0-2.0*(lerp(0.5,1.0,_TextureWashout)-0.5))*(1.0-_Texture_var.rgb)) : (2.0*lerp(0.5,1.0,_TextureWashout)*_Texture_var.rgb) );
                float3 node_4607 = (node_5404*_Color.rgb);
                float3 node_5845 = ((float3(float2(i.screenPos.r,7.5),0.0)+normalDirection+float3(float2((-2.4),i.screenPos.g),0.0))*0.2);
                float4 _FReflection_var = tex2D(_FReflection,TRANSFORM_TEX(node_5845, _FReflection));
                ...
                float3 node_6887 = lerp(float3(node_650,node_650,node_650),lerp(lerp(float3(node_9549,node_9549,node_9549),(node_5404*0.9),_MainTextureColorAO),float3(node_9330,node_9330,node_9330),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
                float3 node_4224 = (node_3766*UNITY_LIGHTMODEL_AMBIENT.rgb*lerp( 1.0, node_6887, _ShowAOonAmbientLight ));
                ...
                float2 node_8416 = (1.0 - (reflect(viewDirection,normalDirection).rg*0.5+0.5));
                float4 _GlossTexture_var = tex2D(_GlossTexture,TRANSFORM_TEX(node_8416, _GlossTexture));
                float3 node_8670 = lerp(_GlossTexture_var.rgb,dot(_GlossTexture_var.rgb,float3(0.3,0.59,0.11)),0.0);
                float node_5993 = 0.0;
                float node_8190 = lerp((lerp( smoothstep( 0.79, 0.9, (node_9744*3.0) ), node_9744, _SoftGloss )*1.0),lerp( node_8670, lerp(float3(node_5993,node_5993,node_5993),node_8670,node_9545), _SelfShadowMaskGlossTexture ),_GlossTextureIntensity);
                float node_1499 = 0.0;
                ...
                float node_3206 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_8466,node_8466,node_8466),saturate((1.0-((1.0-0.44)/node_5404))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_6887,float3(node_7262,node_7262,node_7262),node_9545), node_6887, _ShowAOonLight ))+(lerp(float3(node_1472,node_1472,node_1472),lerp( lerp(float3(node_8190,node_8190,node_8190),(node_8190*_GlossColor.rgb),2.22), lerp(float3(node_1499,node_1499,node_1499),node_5404,node_8190), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_3206,node_3206,node_3206),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),dot(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_8466,node_8466,node_8466),saturate((1.0-((1.0-0.44)/node_5404))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_6887,float3(node_7262,node_7262,node_7262),node_9545), node_6887, _ShowAOonLight ))+(lerp(float3(node_1472,node_1472,node_1472),lerp( lerp(float3(node_8190,node_8190,node_8190),(node_8190*_GlossColor.rgb),2.22), lerp(float3(node_1499,node_1499,node_1499),node_5404,node_8190), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_3206,node_3206,node_3206),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
...
////// Lighting:
                ...
                float3 node_3766 = lerp(node_4607,lerp(_FReflection_var.rgb,node_4607,(1.0 - _MaskFReflection_var.rgb)),_FReflectionIntensity); 
                float node_9545 = smoothstep( lerp(0.3,0.899,_SelfShadowHardness), 0.9, saturate((0.5*dot(lerp( lightDirection, viewDirection, _SelfShadowatViewDirection ),normalDirection)+0.5*lerp(2.8,0.79,_SelfShadowSize))) );
                float node_6054 = (1.0 - node_9545); // Inverted to able to change color
                float node_8466 = 0.0;
                float node_557 = 1.0;
                float4 _SelfShadowPTexture_var = tex2D(_SelfShadowPTexture,TRANSFORM_TEX(float2(i.screenPos.x*(_ScreenParams.r/_ScreenParams.g), i.screenPos.y).rg, _SelfShadowPTexture));
                float node_3933 = 0.0;
                ...
                float node_3073 = 1.0;
                float node_8684 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_3073, node_9545, _FresnelOnLight )*lerp( node_3073, node_6054, _FresnelOnSelfShadow ))));
                float3 node_137 = ((node_8684*_FresnelColor.rgb)*_FresnelIntensity); // Fresnel
                float node_3206 = 0.0;
                float node_5038 = (1.0 - _ReduceWhite);
                float node_3161 = (1.0 - _Saturation);
                float3 finalColor = lerp(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_8466,node_8466,node_8466),saturate((1.0-((1.0-0.44)/node_5404))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_6887,float3(node_7262,node_7262,node_7262),node_9545), node_6887, _ShowAOonLight ))+(lerp(float3(node_1472,node_1472,node_1472),lerp( lerp(float3(node_8190,node_8190,node_8190),(node_8190*_GlossColor.rgb),2.22), lerp(float3(node_1499,node_1499,node_1499),node_5404,node_8190), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_3206,node_3206,node_3206),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),dot(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_8466,node_8466,node_8466),saturate((1.0-((1.0-0.44)/node_5404))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_6887,float3(node_7262,node_7262,node_7262),node_9545), node_6887, _ShowAOonLight ))+(lerp(float3(node_1472,node_1472,node_1472),lerp( lerp(float3(node_8190,node_8190,node_8190),(node_8190*_GlossColor.rgb),2.22), lerp(float3(node_1499,node_1499,node_1499),node_5404,node_8190), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_3206,node_3206,node_3206),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
