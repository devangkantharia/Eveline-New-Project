...
Shader "RealToon/Version 2/Multi Light/No Outline/Default" {
    Properties {
...
////// Emissive:
                ...
                float node_7918 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_3132, node_9545, _FresnelOnLight )*lerp( node_3132, node_6054, _FresnelOnSelfShadow ))));
                float3 node_137 = ((node_7918*_FresnelColor.rgb)*_FresnelIntensity);
                float3 node_2785 = ( lerp(0.5,1.0,_TextureWashout) > 0.5 ? (1.0-(1.0-2.0*(lerp(0.5,1.0,_TextureWashout)-0.5))*(1.0-_Texture_var.rgb)) : (2.0*lerp(0.5,1.0,_TextureWashout)*_Texture_var.rgb) );
                float3 node_4607 = (node_2785*_Color.rgb);
                float3 node_1871 = ((float3(float2(i.screenPos.r,7.5),0.0)+normalDirection+float3(float2((-2.4),i.screenPos.g),0.0))*0.2);
                float4 _FReflection_var = tex2D(_FReflection,TRANSFORM_TEX(node_1871, _FReflection));
                ...
                float3 node_9219 = lerp(float3(node_71,node_71,node_71),lerp(lerp(float3(node_8946,node_8946,node_8946),(node_2785*0.9),_MainTextureColorAO),float3(node_9447,node_9447,node_9447),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
                float3 node_4224 = (node_3766*UNITY_LIGHTMODEL_AMBIENT.rgb*lerp( 1.0, node_9219, _ShowAOonAmbientLight ));
                ...
                float2 node_9280 = (1.0 - (reflect(viewDirection,normalDirection).rg*0.5+0.5));
                float4 _GlossTexture_var = tex2D(_GlossTexture,TRANSFORM_TEX(node_9280, _GlossTexture));
                float3 node_510 = lerp(_GlossTexture_var.rgb,dot(_GlossTexture_var.rgb,float3(0.3,0.59,0.11)),0.0);
                float node_6892 = 0.0;
                float node_7949 = lerp((lerp( smoothstep( 0.79, 0.9, (node_9744*3.0) ), node_9744, _SoftGloss )*1.0),lerp( node_510, lerp(float3(node_6892,node_6892,node_6892),node_510,node_9545), _SelfShadowMaskGlossTexture ),_GlossTextureIntensity);
                float node_3827 = 0.0;
                ...
                float node_9013 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_4633,node_4633,node_4633),saturate((1.0-((1.0-0.44)/node_2785))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_9219,float3(node_5182,node_5182,node_5182),node_9545), node_9219, _ShowAOonLight ))+(lerp(float3(node_45,node_45,node_45),lerp( lerp(float3(node_7949,node_7949,node_7949),(node_7949*_GlossColor.rgb),2.22), lerp(float3(node_3827,node_3827,node_3827),node_2785,node_7949), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_9013,node_9013,node_9013),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),dot(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_4633,node_4633,node_4633),saturate((1.0-((1.0-0.44)/node_2785))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_9219,float3(node_5182,node_5182,node_5182),node_9545), node_9219, _ShowAOonLight ))+(lerp(float3(node_45,node_45,node_45),lerp( lerp(float3(node_7949,node_7949,node_7949),(node_7949*_GlossColor.rgb),2.22), lerp(float3(node_3827,node_3827,node_3827),node_2785,node_7949), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_9013,node_9013,node_9013),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
...
////// Lighting:
                ...
                float node_3132 = 1.0;
                float node_7918 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_3132, node_9545, _FresnelOnLight )*lerp( node_3132, node_6054, _FresnelOnSelfShadow ))));
                float3 node_137 = ((node_7918*_FresnelColor.rgb)*_FresnelIntensity); // Fresnel
                float node_9013 = 0.0;
                float node_5038 = (1.0 - _ReduceWhite);
                float node_3161 = (1.0 - _Saturation);
                float3 finalColor = lerp(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_4633,node_4633,node_4633),saturate((1.0-((1.0-0.44)/node_2785))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_9219,float3(node_5182,node_5182,node_5182),node_9545), node_9219, _ShowAOonLight ))+(lerp(float3(node_45,node_45,node_45),lerp( lerp(float3(node_7949,node_7949,node_7949),(node_7949*_GlossColor.rgb),2.22), lerp(float3(node_3827,node_3827,node_3827),node_2785,node_7949), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_9013,node_9013,node_9013),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),dot(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_4633,node_4633,node_4633),saturate((1.0-((1.0-0.44)/node_2785))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_9219,float3(node_5182,node_5182,node_5182),node_9545), node_9219, _ShowAOonLight ))+(lerp(float3(node_45,node_45,node_45),lerp( lerp(float3(node_7949,node_7949,node_7949),(node_7949*_GlossColor.rgb),2.22), lerp(float3(node_3827,node_3827,node_3827),node_2785,node_7949), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_9013,node_9013,node_9013),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
