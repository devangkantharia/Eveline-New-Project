...
Shader "RealToon/Version 2/Multi Light/No Outline/Double Sided/Fade Transparency" {
    Properties {
        [Header((RealToon V2.0.1))]
    	[Header((Multi Light x No Outline x Double Sided))]
    	[Header((Fade Transparency))]
        ...
        [Space(20)][Header((Transparency))]_Opacity ("Opacity", Range(0, 1)) = 1
        ...
        [Space(20)][Header((Lighting))][MaterialToggle][MaterialToggle] _EnableLightFalloff ("Enable Light Falloff", Float ) = 1
...
////// Emissive:
                ...
                float node_5625 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_7721, node_9545, _FresnelOnLight )*lerp( node_7721, node_6054, _FresnelOnSelfShadow ))));
                float3 node_137 = ((node_5625*_FresnelColor.rgb)*_FresnelIntensity); 
                float3 node_7536 = ( lerp(0.5,1.0,_TextureWashout) > 0.5 ? (1.0-(1.0-2.0*(lerp(0.5,1.0,_TextureWashout)-0.5))*(1.0-_Texture_var.rgb)) : (2.0*lerp(0.5,1.0,_TextureWashout)*_Texture_var.rgb) );
                float3 node_4607 = (node_7536*_Color.rgb);
                float3 node_9221 = ((float3(float2(i.screenPos.r,7.5),0.0)+normalDirection+float3(float2((-2.4),i.screenPos.g),0.0))*0.2);
                float4 _FReflection_var = tex2D(_FReflection,TRANSFORM_TEX(node_9221, _FReflection));
                ...
                float3 node_2096 = lerp(float3(node_9767,node_9767,node_9767),lerp(lerp(float3(node_6993,node_6993,node_6993),(node_7536*0.9),_MainTextureColorAO),float3(node_2538,node_2538,node_2538),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
                float3 node_4224 = (node_3766*UNITY_LIGHTMODEL_AMBIENT.rgb*lerp( 1.0, node_2096, _ShowAOonAmbientLight ));
                ...
                float2 node_8501 = (1.0 - (reflect(viewDirection,normalDirection).rg*0.5+0.5));
                float4 _GlossTexture_var = tex2D(_GlossTexture,TRANSFORM_TEX(node_8501, _GlossTexture));
                float3 node_7157 = lerp(_GlossTexture_var.rgb,dot(_GlossTexture_var.rgb,float3(0.3,0.59,0.11)),0.0);
                float node_926 = 0.0;
                float node_7074 = lerp((lerp( smoothstep( 0.79, 0.9, (node_9744*3.0) ), node_9744, _SoftGloss )*1.0),lerp( node_7157, lerp(float3(node_926,node_926,node_926),node_7157,node_9545), _SelfShadowMaskGlossTexture ),_GlossTextureIntensity);
                float node_8927 = 0.0;
                ...
                float node_8863 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_2930,node_2930,node_2930),saturate((1.0-((1.0-0.44)/node_7536))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_2096,float3(node_7770,node_7770,node_7770),node_9545), node_2096, _ShowAOonLight ))+(lerp(float3(node_4606,node_4606,node_4606),lerp( lerp(float3(node_7074,node_7074,node_7074),(node_7074*_GlossColor.rgb),2.22), lerp(float3(node_8927,node_8927,node_8927),node_7536,node_7074), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_8863,node_8863,node_8863),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),dot(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_2930,node_2930,node_2930),saturate((1.0-((1.0-0.44)/node_7536))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_2096,float3(node_7770,node_7770,node_7770),node_9545), node_2096, _ShowAOonLight ))+(lerp(float3(node_4606,node_4606,node_4606),lerp( lerp(float3(node_7074,node_7074,node_7074),(node_7074*_GlossColor.rgb),2.22), lerp(float3(node_8927,node_8927,node_8927),node_7536,node_7074), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_8863,node_8863,node_8863),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
                fixed4 finalRGBA = fixed4(finalColor,lerp(0.0,_Texture_var.a,_Opacity));
...
////// Lighting:
                ...
                float node_7721 = 1.0;
                float node_5625 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_7721, node_9545, _FresnelOnLight )*lerp( node_7721, node_6054, _FresnelOnSelfShadow ))));
                float3 node_137 = ((node_5625*_FresnelColor.rgb)*_FresnelIntensity); // Fresnel
                float node_8863 = 0.0;
                float node_5038 = (1.0 - _ReduceWhite);
                float node_3161 = (1.0 - _Saturation);
                float3 finalColor = lerp(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_2930,node_2930,node_2930),saturate((1.0-((1.0-0.44)/node_7536))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_2096,float3(node_7770,node_7770,node_7770),node_9545), node_2096, _ShowAOonLight ))+(lerp(float3(node_4606,node_4606,node_4606),lerp( lerp(float3(node_7074,node_7074,node_7074),(node_7074*_GlossColor.rgb),2.22), lerp(float3(node_8927,node_8927,node_8927),node_7536,node_7074), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_8863,node_8863,node_8863),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),dot(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_2930,node_2930,node_2930),saturate((1.0-((1.0-0.44)/node_7536))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_2096,float3(node_7770,node_7770,node_7770),node_9545), node_2096, _ShowAOonLight ))+(lerp(float3(node_4606,node_4606,node_4606),lerp( lerp(float3(node_7074,node_7074,node_7074),(node_7074*_GlossColor.rgb),2.22), lerp(float3(node_8927,node_8927,node_8927),node_7536,node_7074), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_8863,node_8863,node_8863),_FresnelVisibleOnDarkAmbientLight))*(_LightColor0.rgb*lerp( step(0.001,attenuation), attenuation, _EnableLightFalloff ))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
                fixed4 finalRGBA = fixed4(finalColor * lerp(0.0,_Texture_var.a,_Opacity),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
