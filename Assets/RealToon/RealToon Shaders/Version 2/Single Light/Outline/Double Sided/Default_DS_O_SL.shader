...
Shader "RealToon/Version 2/Single Light/Outline/Double Sided/Default" {
    Properties {
        [Header((RealToon V2.0.1))]
    	[Header((Single Light x Outline x Double Sided))]
    	[Header((Default))]
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_5371_ang = node_8201.g;
...
////// Emissive:
                ...
                float node_8989 = (attenuation*node_9545);
                float node_5035 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_9261, node_8989, _FresnelOnLight )*lerp( node_9261, (1.0 - node_8989), _FresnelOnShadow ))));
                float3 node_137 = ((node_5035*_FresnelColor.rgb)*_FresnelIntensity); 
                float3 node_9628 = ( lerp(0.5,1.0,_TextureWashout) > 0.5 ? (1.0-(1.0-2.0*(lerp(0.5,1.0,_TextureWashout)-0.5))*(1.0-_Texture_var.rgb)) : (2.0*lerp(0.5,1.0,_TextureWashout)*_Texture_var.rgb) );
                float3 node_4607 = (node_9628*_Color.rgb);
                float3 node_3271 = ((float3(float2(i.screenPos.r,7.5),0.0)+normalDirection+float3(float2((-2.4),i.screenPos.g),0.0))*0.2);
                float4 _FReflection_var = tex2D(_FReflection,TRANSFORM_TEX(node_3271, _FReflection));
                ...
                float3 node_2610 = lerp(float3(node_9682,node_9682,node_9682),lerp(lerp(float3(node_4166,node_4166,node_4166),(node_9628*0.9),_MainTextureColorAO),float3(node_4117,node_4117,node_4117),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
                float3 node_4224 = (node_3766*UNITY_LIGHTMODEL_AMBIENT.rgb*lerp( 1.0, node_2610, _ShowAOonAmbientLight ));
                ...
                float3 emissive = lerp(saturate(min((lerp((0.0*node_137),((node_5035*_FresnelColor.rgb)*_FresnelIntensity),_FresnelVisibleOnDarkAmbientLight)+lerp(node_4224,lerp(node_4224,(_SelfLitColor.rgb*node_3766*_SelfLitPower),_MaskSelfLit_var.rgb),lerp(0.0,1.0,_SelfLitIntensity))),node_5038)),dot(saturate(min((lerp((0.0*node_137),((node_5035*_FresnelColor.rgb)*_FresnelIntensity),_FresnelVisibleOnDarkAmbientLight)+lerp(node_4224,lerp(node_4224,(_SelfLitColor.rgb*node_3766*_SelfLitPower),_MaskSelfLit_var.rgb),lerp(0.0,1.0,_SelfLitIntensity))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
                float node_7377 = (lerp(1.0,attenuation,_ReceiveShadowsIntensity)*lerp(1.0,node_9545,_SelfShadowIntensity));
                float node_7571 = lerp(1.0,node_7377,lerp(0.0,lerp(1.0,2.6,_MainTextureColorShadow),_ShadowIntensity));
                float node_6054 = (1.0 - node_7571); 
                float node_3266 = 0.0;
                float node_7129 = 0.0;
                float node_557 = 1.0;
                ...
                float2 node_8140 = (1.0 - (reflect(viewDirection,normalDirection).rg*0.5+0.5));
                float4 _GlossTexture_var = tex2D(_GlossTexture,TRANSFORM_TEX(node_8140, _GlossTexture));
                float3 node_5622 = lerp(_GlossTexture_var.rgb,dot(_GlossTexture_var.rgb,float3(0.3,0.59,0.11)),0.0);
                float node_7623 = 0.0;
                float node_3923 = lerp((lerp( smoothstep( 0.79, 0.9, (node_9744*3.0) ), node_9744, _SoftGloss )*1.0),lerp( node_5622, lerp(float3(node_7623,node_7623,node_7623),node_5622,node_8989), _ShadowMaskGlossTexture ),_GlossTextureIntensity);
                float node_1756 = 0.0;
                ...
                float node_7639 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min(((((node_3766*(lerp(float3(node_7571,node_7571,node_7571),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_3266,node_3266,node_3266),saturate((1.0-((1.0-0.44)/node_9628))),node_6054),_MainTextureColorShadow),lerp(float3(node_7129,node_7129,node_7129),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_7377)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_2610,float3(node_3437,node_3437,node_3437),node_7377), node_2610, _ShowAOonLight ))+(lerp(float3(node_2898,node_2898,node_2898),lerp( lerp(float3(node_3923,node_3923,node_3923),(node_3923*_GlossColor.rgb),2.22), lerp(float3(node_1756,node_1756,node_1756),node_9628,node_3923), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_7639,node_7639,node_7639),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),dot(saturate(min(((((node_3766*(lerp(float3(node_7571,node_7571,node_7571),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_3266,node_3266,node_3266),saturate((1.0-((1.0-0.44)/node_9628))),node_6054),_MainTextureColorShadow),lerp(float3(node_7129,node_7129,node_7129),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_7377)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_2610,float3(node_3437,node_3437,node_3437),node_7377), node_2610, _ShowAOonLight ))+(lerp(float3(node_2898,node_2898,node_2898),lerp( lerp(float3(node_3923,node_3923,node_3923),(node_3923*_GlossColor.rgb),2.22), lerp(float3(node_1756,node_1756,node_1756),node_9628,node_3923), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_7639,node_7639,node_7639),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),float3(0.3,0.59,0.11)),node_3161);
