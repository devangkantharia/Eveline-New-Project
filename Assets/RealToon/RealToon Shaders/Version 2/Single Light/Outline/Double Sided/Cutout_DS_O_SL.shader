...
Shader "RealToon/Version 2/Single Light/Outline/Double Sided/Cutout" {
    Properties {
        ...
        [Space(20)][Header((FReflection))]_FReflectionIntensity ("FReflection Intensity", Range(0, 1)) = 0.5008138
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_5371_ang = node_5853.g;
...
////// Emissive:
                ...
                float node_3111 = (attenuation*node_9545);
                float node_117 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_8649, node_3111, _FresnelOnLight )*lerp( node_8649, (1.0 - node_3111), _FresnelOnShadow ))));
                float3 node_137 = ((node_117*_FresnelColor.rgb)*_FresnelIntensity); 
                float3 node_7152 = ( lerp(0.5,1.0,_TextureWashout) > 0.5 ? (1.0-(1.0-2.0*(lerp(0.5,1.0,_TextureWashout)-0.5))*(1.0-_Texture_var.rgb)) : (2.0*lerp(0.5,1.0,_TextureWashout)*_Texture_var.rgb) );
                float3 node_4607 = (node_7152*_Color.rgb);
                float3 node_4162 = ((float3(float2(i.screenPos.r,7.5),0.0)+float3(float2((-2.4),i.screenPos.g),0.0)+normalDirection)*0.2);
                float4 _FReflection_var = tex2D(_FReflection,TRANSFORM_TEX(node_4162, _FReflection));
                ...
                float3 node_803 = lerp(float3(node_5452,node_5452,node_5452),lerp(lerp(float3(node_9461,node_9461,node_9461),(node_7152*0.9),_MainTextureColorAO),float3(node_695,node_695,node_695),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
                float3 node_4224 = (node_3766*UNITY_LIGHTMODEL_AMBIENT.rgb*lerp( 1.0, node_803, _ShowAOonAmbientLight ));
                ...
                float3 emissive = lerp(saturate(min((lerp((0.0*node_137),((node_117*_FresnelColor.rgb)*_FresnelIntensity),_FresnelVisibleOnDarkAmbientLight)+lerp(node_4224,lerp(node_4224,(_SelfLitColor.rgb*node_3766*_SelfLitPower),_MaskSelfLit_var.rgb),lerp(0.0,1.0,_SelfLitIntensity))),node_5038)),dot(saturate(min((lerp((0.0*node_137),((node_117*_FresnelColor.rgb)*_FresnelIntensity),_FresnelVisibleOnDarkAmbientLight)+lerp(node_4224,lerp(node_4224,(_SelfLitColor.rgb*node_3766*_SelfLitPower),_MaskSelfLit_var.rgb),lerp(0.0,1.0,_SelfLitIntensity))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
                float node_7714 = (lerp(1.0,attenuation,_ReceiveShadowsIntensity)*lerp(1.0,node_9545,_SelfShadowIntensity));
                float node_3113 = lerp(1.0,node_7714,lerp(0.0,lerp(1.0,2.6,_MainTextureColorShadow),_ShadowIntensity));
                float node_6054 = (1.0 - node_3113); 
                float node_4623 = 0.0;
                float node_660 = 0.0;
                float node_557 = 1.0;
                ...
                float2 node_4350 = (1.0 - (reflect(viewDirection,normalDirection).rg*0.5+0.5));
                float4 _GlossTexture_var = tex2D(_GlossTexture,TRANSFORM_TEX(node_4350, _GlossTexture));
                float3 node_9413 = lerp(_GlossTexture_var.rgb,dot(_GlossTexture_var.rgb,float3(0.3,0.59,0.11)),0.0);
                float node_5620 = 0.0;
                float node_4085 = lerp((lerp( smoothstep( 0.79, 0.9, (node_9744*3.0) ), node_9744, _SoftGloss )*1.0),lerp( node_9413, lerp(float3(node_5620,node_5620,node_5620),node_9413,node_3111), _ShadowMaskGlossTexture ),_GlossTextureIntensity);
                float node_388 = 0.0;
                ...
                float node_2019 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min(((((node_3766*(lerp(float3(node_3113,node_3113,node_3113),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_4623,node_4623,node_4623),saturate((1.0-((1.0-0.44)/node_7152))),node_6054),_MainTextureColorShadow),lerp(float3(node_660,node_660,node_660),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_7714)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_803,float3(node_4286,node_4286,node_4286),node_7714), node_803, _ShowAOonLight ))+(lerp(float3(node_6852,node_6852,node_6852),lerp( lerp(float3(node_4085,node_4085,node_4085),(node_4085*_GlossColor.rgb),2.22), lerp(float3(node_388,node_388,node_388),node_7152,node_4085), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_2019,node_2019,node_2019),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),dot(saturate(min(((((node_3766*(lerp(float3(node_3113,node_3113,node_3113),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_4623,node_4623,node_4623),saturate((1.0-((1.0-0.44)/node_7152))),node_6054),_MainTextureColorShadow),lerp(float3(node_660,node_660,node_660),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_7714)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_803,float3(node_4286,node_4286,node_4286),node_7714), node_803, _ShowAOonLight ))+(lerp(float3(node_6852,node_6852,node_6852),lerp( lerp(float3(node_4085,node_4085,node_4085),(node_4085*_GlossColor.rgb),2.22), lerp(float3(node_388,node_388,node_388),node_7152,node_4085), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_2019,node_2019,node_2019),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),float3(0.3,0.59,0.11)),node_3161);
