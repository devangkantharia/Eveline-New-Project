    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = v.texcoord0;
                float4 node_740 = _Time + _TimeEditor;
                float node_5371_ang = node_740.g;
...
////// Emissive:
                ...
                float3 node_9511 = ((float3(float2(i.screenPos.r,7.5),0.0)+normalDirection+float3(float2((-2.4),i.screenPos.g),0.0))*0.2);
                float4 _FReflection_var = tex2D(_FReflection,TRANSFORM_TEX(node_9511, _FReflection));
                ...
                float3 node_2724 = lerp(float3(node_1736,node_1736,node_1736),lerp(lerp(float3(node_939,node_939,node_939),(node_9875*0.9),_MainTextureColorAO),float3(node_1159,node_1159,node_1159),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
                ...
                float node_1292 = 0.0;
                float node_3179 = lerp((lerp( smoothstep( 0.79, 0.9, (node_9744*3.0) ), node_9744, _SoftGloss )*1.0),lerp( node_3708, lerp(float3(node_1292,node_1292,node_1292),node_3708,node_2697), _ShadowMaskGlossTexture ),_GlossTextureIntensity);
                float node_7359 = 0.0;
                ...
                float node_8355 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min(((((node_3766*(lerp(float3(node_2192,node_2192,node_2192),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_6731,node_6731,node_6731),saturate((1.0-((1.0-0.44)/node_9875))),node_6054),_MainTextureColorShadow),lerp(float3(node_7988,node_7988,node_7988),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_7397)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_2724,float3(node_3448,node_3448,node_3448),node_7397), node_2724, _ShowAOonLight ))+(lerp(float3(node_7581,node_7581,node_7581),lerp( lerp(float3(node_3179,node_3179,node_3179),(node_3179*_GlossColor.rgb),2.22), lerp(float3(node_7359,node_7359,node_7359),node_9875,node_3179), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_8355,node_8355,node_8355),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),dot(saturate(min(((((node_3766*(lerp(float3(node_2192,node_2192,node_2192),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_6731,node_6731,node_6731),saturate((1.0-((1.0-0.44)/node_9875))),node_6054),_MainTextureColorShadow),lerp(float3(node_7988,node_7988,node_7988),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_7397)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_2724,float3(node_3448,node_3448,node_3448),node_7397), node_2724, _ShowAOonLight ))+(lerp(float3(node_7581,node_7581,node_7581),lerp( lerp(float3(node_3179,node_3179,node_3179),(node_3179*_GlossColor.rgb),2.22), lerp(float3(node_7359,node_7359,node_7359),node_9875,node_3179), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_8355,node_8355,node_8355),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),float3(0.3,0.59,0.11)),node_3161);
