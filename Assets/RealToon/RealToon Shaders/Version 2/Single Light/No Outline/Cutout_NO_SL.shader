...
Shader "RealToon/Version 2/Single Light/No Outline/Cutout" {
    Properties {
...
////// Emissive:
                ...
                float node_3315 = (attenuation*node_9545);
                float node_2224 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_8166, node_3315, _FresnelOnLight )*lerp( node_8166, (1.0 - node_3315), _FresnelOnShadow ))));
                float3 node_137 = ((node_2224*_FresnelColor.rgb)*_FresnelIntensity); 
                float3 node_4751 = ( lerp(0.5,1.0,_TextureWashout) > 0.5 ? (1.0-(1.0-2.0*(lerp(0.5,1.0,_TextureWashout)-0.5))*(1.0-_Texture_var.rgb)) : (2.0*lerp(0.5,1.0,_TextureWashout)*_Texture_var.rgb) );
                float3 node_4607 = (node_4751*_Color.rgb);
                float3 node_7685 = ((float3(float2(i.screenPos.r,7.5),0.0)+normalDirection+float3(float2((-2.4),i.screenPos.g),0.0))*0.2);
                float4 _FReflection_var = tex2D(_FReflection,TRANSFORM_TEX(node_7685, _FReflection));
                ...
                float3 node_9317 = lerp(float3(node_1395,node_1395,node_1395),lerp(lerp(float3(node_1294,node_1294,node_1294),(node_4751*0.9),_MainTextureColorAO),float3(node_6480,node_6480,node_6480),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
                float3 node_4224 = (node_3766*UNITY_LIGHTMODEL_AMBIENT.rgb*lerp( 1.0, node_9317, _ShowAOonAmbientLight ));
                ...
                float3 emissive = lerp(saturate(min((lerp((0.0*node_137),((node_2224*_FresnelColor.rgb)*_FresnelIntensity),_FresnelVisibleOnDarkAmbientLight)+lerp(node_4224,lerp(node_4224,(_SelfLitColor.rgb*node_3766*_SelfLitPower),_MaskSelfLit_var.rgb),lerp(0.0,1.0,_SelfLitIntensity))),node_5038)),dot(saturate(min((lerp((0.0*node_137),((node_2224*_FresnelColor.rgb)*_FresnelIntensity),_FresnelVisibleOnDarkAmbientLight)+lerp(node_4224,lerp(node_4224,(_SelfLitColor.rgb*node_3766*_SelfLitPower),_MaskSelfLit_var.rgb),lerp(0.0,1.0,_SelfLitIntensity))),node_5038)),float3(0.3,0.59,0.11)),node_3161);
                float node_4536 = (lerp(1.0,attenuation,_ReceiveShadowsIntensity)*lerp(1.0,node_9545,_SelfShadowIntensity));
                float node_1438 = lerp(1.0,node_4536,lerp(0.0,lerp(1.0,2.6,_MainTextureColorShadow),_ShadowIntensity));
                float node_6054 = (1.0 - node_1438); 
                float node_5678 = 0.0;
                float node_5427 = 0.0;
                float node_557 = 1.0;
                ...
                float2 node_7823 = (1.0 - (reflect(viewDirection,normalDirection).rg*0.5+0.5));
                float4 _GlossTexture_var = tex2D(_GlossTexture,TRANSFORM_TEX(node_7823, _GlossTexture));
                float3 node_4728 = lerp(_GlossTexture_var.rgb,dot(_GlossTexture_var.rgb,float3(0.3,0.59,0.11)),0.0);
                float node_9752 = 0.0;
                float node_7346 = lerp((lerp( smoothstep( 0.79, 0.9, (node_9744*3.0) ), node_9744, _SoftGloss )*1.0),lerp( node_4728, lerp(float3(node_9752,node_9752,node_9752),node_4728,node_3315), _ShadowMaskGlossTexture ),_GlossTextureIntensity);
                float node_8530 = 0.0;
                ...
                float node_7701 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min(((((node_3766*(lerp(float3(node_1438,node_1438,node_1438),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_5678,node_5678,node_5678),saturate((1.0-((1.0-0.44)/node_4751))),node_6054),_MainTextureColorShadow),lerp(float3(node_5427,node_5427,node_5427),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_4536)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_9317,float3(node_6031,node_6031,node_6031),node_4536), node_9317, _ShowAOonLight ))+(lerp(float3(node_3306,node_3306,node_3306),lerp( lerp(float3(node_7346,node_7346,node_7346),(node_7346*_GlossColor.rgb),2.22), lerp(float3(node_8530,node_8530,node_8530),node_4751,node_7346), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_7701,node_7701,node_7701),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),dot(saturate(min(((((node_3766*(lerp(float3(node_1438,node_1438,node_1438),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_5678,node_5678,node_5678),saturate((1.0-((1.0-0.44)/node_4751))),node_6054),_MainTextureColorShadow),lerp(float3(node_5427,node_5427,node_5427),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_4536)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_9317,float3(node_6031,node_6031,node_6031),node_4536), node_9317, _ShowAOonLight ))+(lerp(float3(node_3306,node_3306,node_3306),lerp( lerp(float3(node_7346,node_7346,node_7346),(node_7346*_GlossColor.rgb),2.22), lerp(float3(node_8530,node_8530,node_8530),node_4751,node_7346), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_7701,node_7701,node_7701),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),float3(0.3,0.59,0.11)),node_3161);
