...
Shader "RealToon/Version 2/Single Light/No Outline/Fade Transparency" {
    Properties {
...
////// Emissive:
                ...
                float node_2784 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_2587, node_9545, _FresnelOnLight )*lerp( node_2587, node_6054, _FresnelOnSelfShadow ))));
                float3 node_137 = ((node_2784*_FresnelColor.rgb)*_FresnelIntensity); 
                float3 node_3456 = ( lerp(0.5,1.0,_TextureWashout) > 0.5 ? (1.0-(1.0-2.0*(lerp(0.5,1.0,_TextureWashout)-0.5))*(1.0-_Texture_var.rgb)) : (2.0*lerp(0.5,1.0,_TextureWashout)*_Texture_var.rgb) );
                float3 node_4607 = (node_3456*_Color.rgb);
                float3 node_8960 = ((float3(float2(i.screenPos.r,7.5),0.0)+normalDirection+float3(float2((-2.4),i.screenPos.g),0.0))*0.2);
                float4 _FReflection_var = tex2D(_FReflection,TRANSFORM_TEX(node_8960, _FReflection));
                ...
                float node_9212 = 1.0;
                float3 _MainTextureColorAO_var = lerp( 0.0, (node_3456*0.9), _MainTextureColorAO );
                float node_3176 = 1.0;
                float4 _AOTexture_var = tex2D(_AOTexture,TRANSFORM_TEX(i.uv0, _AOTexture));
                float node_7035 = 0.0;
                float node_6431 = 1.0;
                float node_2892 = 10.0;
                float3 node_2411 = lerp(float3(node_9212,node_9212,node_9212),lerp(_MainTextureColorAO_var,float3(node_3176,node_3176,node_3176),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(float3(node_7035,node_7035,node_7035),lerp(float3(node_6431,node_6431,node_6431),float3(node_2892,node_2892,node_2892),_MainTextureColorAO_var),_AOIntensity));
                float3 node_4224 = (node_3766*UNITY_LIGHTMODEL_AMBIENT.rgb*lerp( 1.0, node_2411, _ShowAOonAmbientLight ));
                ...
                float2 node_3145 = (1.0 - (reflect(viewDirection,normalDirection).rg*0.5+0.5));
                float4 _GlossTexture_var = tex2D(_GlossTexture,TRANSFORM_TEX(node_3145, _GlossTexture));
                float3 node_744 = lerp(_GlossTexture_var.rgb,dot(_GlossTexture_var.rgb,float3(0.3,0.59,0.11)),0.0);
                float node_9963 = 0.0;
                float node_2088 = lerp((lerp( smoothstep( 0.79, 0.9, (node_9744*3.0) ), node_9744, _SoftGloss )*1.0),lerp( node_744, lerp(float3(node_9963,node_9963,node_9963),node_744,node_9545), _ShadowMaskGlossTexture ),_GlossTextureIntensity);
                float node_6186 = 0.0;
                ...
                float node_5661 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_6905,node_6905,node_6905),saturate((1.0-((1.0-0.44)/node_3456))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_2411,float3(node_2997,node_2997,node_2997),node_9545), node_2411, _ShowAOonLight ))+(lerp(float3(node_7422,node_7422,node_7422),lerp( lerp(float3(node_2088,node_2088,node_2088),(node_2088*_GlossColor.rgb),2.22), lerp(float3(node_6186,node_6186,node_6186),node_3456,node_2088), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_5661,node_5661,node_5661),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),dot(saturate(min((((lerp(node_3766,(node_3766*(lerp(float3(node_9545,node_9545,node_9545),lerp(lerp((node_6054*_SelfShadowColor.rgb),lerp(float3(node_6905,node_6905,node_6905),saturate((1.0-((1.0-0.44)/node_3456))),node_6054),_MainTextureColorSelfShadow),lerp((lerp(float3(node_557,node_557,node_557),_SelfShadowPTexture_var.rgb,_SelfShadowPTexture_var.a)*0.54),float3(node_3933,node_3933,node_3933),node_9545),_SelfShadowPTextureIntensity),0.65)*2.86)),lerp(0.0,lerp(1.0,2.6,_MainTextureColorSelfShadow),_SelfShadowIntensity))*lerp( lerp(node_2411,float3(node_2997,node_2997,node_2997),node_9545), node_2411, _ShowAOonLight ))+(lerp(float3(node_7422,node_7422,node_7422),lerp( lerp(float3(node_2088,node_2088,node_2088),(node_2088*_GlossColor.rgb),2.22), lerp(float3(node_6186,node_6186,node_6186),node_3456,node_2088), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_5661,node_5661,node_5661),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),float3(0.3,0.59,0.11)),node_3161);
