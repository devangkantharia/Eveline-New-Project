...
////// Emissive:
                ...
                float node_5221 = (_HardEdgeFresnel_var*lerp(0.0,_HardEdgeFresnel_var,(lerp( node_5638, node_3614, _FresnelOnLight )*lerp( node_5638, (1.0 - node_3614), _FresnelOnShadow ))));
                float3 node_137 = ((node_5221*_FresnelColor.rgb)*_FresnelIntensity); 
                float3 node_4487 = ( lerp(0.5,1.0,_TextureWashout) > 0.5 ? (1.0-(1.0-2.0*(lerp(0.5,1.0,_TextureWashout)-0.5))*(1.0-_Texture_var.rgb)) : (2.0*lerp(0.5,1.0,_TextureWashout)*_Texture_var.rgb) );
                float3 node_4607 = (node_4487*_Color.rgb);
                float3 node_8727 = ((float3(float2(i.screenPos.r,7.5),0.0)+normalDirection+float3(float2((-2.4),i.screenPos.g),0.0))*0.2);
                float4 _FReflection_var = tex2D(_FReflection,TRANSFORM_TEX(node_8727, _FReflection));
                ...
                float3 node_3573 = lerp(float3(node_8557,node_8557,node_8557),lerp(lerp(float3(node_6822,node_6822,node_6822),(node_4487*0.9),_MainTextureColorAO),float3(node_2585,node_2585,node_2585),lerp(_AOTexture_var.rgb,dot(_AOTexture_var.rgb,float3(0.3,0.59,0.11)),1.0)),lerp(0.0,lerp(1.0,10.0,_MainTextureColorAO),_AOIntensity));
                ...
                float2 node_7344 = (1.0 - (reflect(viewDirection,normalDirection).rg*0.5+0.5));
                float4 _GlossTexture_var = tex2D(_GlossTexture,TRANSFORM_TEX(node_7344, _GlossTexture));
                float3 node_3844 = lerp(_GlossTexture_var.rgb,dot(_GlossTexture_var.rgb,float3(0.3,0.59,0.11)),0.0);
                float node_2886 = 0.0;
                float node_6503 = lerp((lerp( smoothstep( 0.79, 0.9, (node_9744*3.0) ), node_9744, _SoftGloss )*1.0),lerp( node_3844, lerp(float3(node_2886,node_2886,node_2886),node_3844,node_3614), _ShadowMaskGlossTexture ),_GlossTextureIntensity);
                float node_8747 = 0.0;
                ...
                float node_4309 = 0.0;
                float3 finalColor = emissive + lerp(saturate(min(((((node_3766*(lerp(float3(node_505,node_505,node_505),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_988,node_988,node_988),saturate((1.0-((1.0-0.44)/node_4487))),node_6054),_MainTextureColorShadow),lerp(float3(node_9082,node_9082,node_9082),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_9036)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_3573,float3(node_356,node_356,node_356),node_9036), node_3573, _ShowAOonLight ))+(lerp(float3(node_7287,node_7287,node_7287),lerp( lerp(float3(node_6503,node_6503,node_6503),(node_6503*_GlossColor.rgb),2.22), lerp(float3(node_8747,node_8747,node_8747),node_4487,node_6503), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_4309,node_4309,node_4309),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),dot(saturate(min(((((node_3766*(lerp(float3(node_505,node_505,node_505),lerp(lerp((node_6054*_ShadowColor.rgb),lerp(float3(node_988,node_988,node_988),saturate((1.0-((1.0-0.44)/node_4487))),node_6054),_MainTextureColorShadow),lerp(float3(node_9082,node_9082,node_9082),(lerp(lerp(float3(node_557,node_557,node_557),_ShadowPTexture_var.rgb,_ShadowPTexture_var.a),float3(node_3933,node_3933,node_3933),node_9036)*lerp(0.54,1.65,_MainTextureColorShadow)),_ShadowIntensity),_ShadowPTextureIntensity),0.65)*2.86))*lerp( lerp(node_3573,float3(node_356,node_356,node_356),node_9036), node_3573, _ShowAOonLight ))+(lerp(float3(node_7287,node_7287,node_7287),lerp( lerp(float3(node_6503,node_6503,node_6503),(node_6503*_GlossColor.rgb),2.22), lerp(float3(node_8747,node_8747,node_8747),node_4487,node_6503), _MainTextureColorGloss ),_GlossMask_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(node_137,float3(node_4309,node_4309,node_4309),_FresnelVisibleOnDarkAmbientLight))*_LightColor0.rgb),node_5038)),float3(0.3,0.59,0.11)),node_3161);
